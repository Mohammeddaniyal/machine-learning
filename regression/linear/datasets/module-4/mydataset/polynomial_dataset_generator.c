...
{
	mlfw_mat_double *source_matrix;
	mlfw_mat_double *target_matrix;
	...
	mlfw_row_vec_string *source_matrix_header;
	mlfw_row_vec_string *target_matrix_header;
	mlfw_row_vec_double *feature_vector;
	mlfw_row_vec_double *polynomial_feature_vector;
	char heading[11];
