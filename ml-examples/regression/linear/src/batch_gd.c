...
mlfw_gradient_descent_lin_reg_progress_call_t mlfw_gradient_descent_options_get_number_of_iterations(mlfw_gradient_descent_options *gradient_descent)
{
	mlfw_reset_error();
	if(gd_options==NULL)
	{
...
mlfw_gradient_descent_lin_reg_data_provider_t mlfw_gradient_descent_options_get_number_of_iterations(mlfw_gradient_descent_options *gradient_descent)
{
	mlfw_reset_error();
	if(gd_options==NULL)
	{
