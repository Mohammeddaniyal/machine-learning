...
int main(int args,char *argv[])
{
	...
	matrix=dmlfw_mat_double_from_csv(dataset_file,NULL,&header);
	if(matrix==NULL)
	{
...
dmlfw_mat_double_copy(major_matrix,shuffled_matrix,0,0,minor_rows,0,shuffled_matrix_rows-1,shuffled_matrix_columns-1);
	...
	dmlfw_mat_double_to_csv(minor_matrix,test_file,header);
	dmlfw_mat_double_to_csv(major_matrix,train_file,header);
