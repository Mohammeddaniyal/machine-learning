...
{
	dmlfw_mat_double *source_matrix;
	dmlfw_mat_double *target_matrix;
	...
	dmlfw_row_vec_string *source_matrix_header;
	dmlfw_row_vec_string *target_matrix_header;
	dmlfw_row_vec_double *feature_vector;
	dmlfw_row_vec_double *polynomial_feature_vector;
	char heading[11];
