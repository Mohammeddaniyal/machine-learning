...
int main(int argc,char *argv[])
{
	...
	trained_parameters=dmlfw_linear_regression_gradient_descent_fit_line(training_examples_matrix,training_examples_target_values_vector,0.0003,atoi(argv[1]),screen_logger);
